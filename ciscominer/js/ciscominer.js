var preLoad = {
  ...
  newsarr: [
    ...
    "gyak (//balu) (H:) Szeba",
    "Nem lopott!",
    "The cisco stock price is 48,35$",
    "Cisco Packer Tracer 8.2.1",
    "Click those Cisco products!",
    "The Cisco hq is located at Burkina Faso",
    "Who needs friends when you have Cisco Packet Tracer 8.3?",
    "Packet Tracer: Because breaking real routers is expensive.",
    "Who needs a lab partner? You have Cisco Packet Tracer.",
  ],
